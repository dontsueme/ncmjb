...
public interface MPlayerProcessListener {
	void handleMplayerStdOutErr(String line);
	void errorOccurred(MPlayerProcess.Error error);
	void processEnded(Integer exitValue);
}
